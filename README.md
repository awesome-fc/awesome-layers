...
| PHP80                        | `acs:fc:{region}:official:layers/PHP80/versions/7`                        | [README.md](docs/PHP80/README.md)                        | `custom`  | PHP 8.0.22                                                             | 函数计算 |
| PHP72                        | `acs:fc:{region}:official:layers/PHP72/versions/6`                        | [README.md](docs/PHP72/README.md)                        | `custom`  | PHP 7.2.8                                                              | 函数计算 |
