...
| Nodejs-Aliyun-SDK | `acs:fc:{region}:official:layers/Nodejs-Aliyun-SDK/versions/2`</br>阿里云常用SDK (Nodejs16/Nodejs14/Nodejs12) | `nodejs16`</br>`nodejs14`</br>`nodejs12`</br>`custom`</br>`custom.debian10`  | 暂无明确时间 | 函数计算 |
