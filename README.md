...
| Nodejs22                     | `acs:fc:{region}:official:layers/Nodejs22/versions/3`</br>[README.md](docs/Nodejs22/README.md)                     | `custom.debian12`</br>`custom.debian11` | 暂无明确时间 |
| Nodejs24                     | `acs:fc:{region}:official:layers/Nodejs24/versions/1`</br>[README.md](docs/Nodejs24/README.md)                     | `custom.debian12`</br>`custom.debian11` | 暂无明确时间 |
...
| PuppeteerLib | `acs:fc:{region}:1940309364339785:layers/PuppeteerLib/versions/1`</br>[github.com/fanzhe/fc-layer/puppeteer-lib](https://github.com/fanzhe328/fc-layer/blob/main/layers/puppeteer-lib/README.md)) | `custom`</br>`nodejs16`</br>`nodejs14`</br>`nodejs12`</br>`nodejs10`</br>`nodejs8`  | 暂无明确时间 | [fanzhe](https://github.com/fanzhe328/fc-layer) |
...
| Nodejs-Aliyun-SDK | `acs:fc:{region}:official:layers/Nodejs-Aliyun-SDK/versions/4`</br>阿里云常用SDK | `nodejs20`</br>`nodejs18`</br>`nodejs16`</br>`nodejs14`</br>`custom`</br>`custom.debian10`</br>`custom.debian11`  | 暂无明确时间 | 函数计算 |
